...
- **周边校园场景**：道路、广场、约 110 棵树、7 栋周边建筑、150 余盏高杆路灯与庭院灯，让楼"长"在真实校园里。
- **校园人气**：约 60 名低模小人（球头 + 圆柱身 + 圆棍四肢，配帽子等小配饰，衣色各异），在校园里自由走动——有独行的、两三结伴的、也有驻足交谈的；白天人多、夜晚人少。只在有地面时出现（查看地下层或进入楼层导引时会自动隐藏）。
- **双主题美学**：
  - **图纸主题**（浅）——米白底 `#FAF7F2` + 暖木舱体 + 细墨线，与设计图纸、展板完全一致；
  - **夜航主题**（深）——炭黑底 `#0E1116` + 青色描边微辉光 + 星空月亮 + 走廊灯带 + 约 70% 舱体亮窗；周边建筑大片亮窗 + 底层光带 + 屋顶航空灯，校园 150 余盏路灯三重发光（灯头/辉光/地面光晕），夜景更耐看，答辩投影用。
